...
b||null)};e.version="2152fdf";e.isSupported=true;e.instances=[];e.p=e.prototype={init:function(a,b){var o,m=this;if(typeof a==="function")if(f.readyState==="complete")a(f,e);else{n.push(a);if(!r){r=true;var t=function(){f.removeEventListener("DOMContentLoaded",t,false);for(var F=0,B=n.length;F<B;F++)n[F].call(f,e);n=null};f.addEventListener("DOMContentLoaded",t,false)}}else{if(typeof a==="string")try{o=f.querySelector(a)}catch(u){throw Error("Popcorn.js Error: Invalid media element selector: "+a);
